...
The western art of combat with [rapiers][2] or rapier-like swords. It can also be set to `true` to use fences like _(\`\`\`)_ instead of spaces `    ` when delimiting code blocks.
